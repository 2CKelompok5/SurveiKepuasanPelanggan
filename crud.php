...
class Crud
{
    ...
    public function deleteKategoriSoal($kategori_nama)
    {
    ...
    {
        $query = "SELECT * FROM responden_dosen";
        $result = $this->db->conn->query($query);
        $data = [];
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
    ...
    {
        $query = "SELECT * FROM responden_tendik";
        $result = $this->db->conn->query($query);
        $data = [];
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
    ...
    {
        $query = "SELECT * FROM responden_mahasiswa";
        $result = $this->db->conn->query($query);
        $data = [];
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
    ...
    {
        $query = "SELECT * FROM responden_alumni";
        $result = $this->db->conn->query($query);
        $data = [];
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
    ...
    {
        $query = "SELECT * FROM responden_ortu";
        $result = $this->db->conn->query($query);
        $data = [];
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
    ...
    {
        $query = "SELECT * FROM responden_industri";
        $result = $this->db->conn->query($query);
        $data = [];
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
    ...
    public function createSurveySoal($survey_id, $kategori_id, $no_urut, $soal_nama)
    {
        $query = "INSERT INTO survey_soal(survey_id, kategori_id, no_urut, soal_nama) VALUES('$survey_id', '$kategori_id', '$no_urut', '$soal_nama')";
        $result = $this->db->conn->query($query);
        return $result;
    }
    //  Read Survey Soal
    ...
    // Update Survey Soal
    public function updateSurveySoal($kategori_id, $no_urut, $soal_nama_baru)
    {
        $query = "UPDATE survey_soal SET soal_nama ='$soal_nama_baru' WHERE kategori_id = $kategori_id AND no_urut =$no_urut";
        $result = $this->db->conn->query($query);
        return $result;
    }
    // Delete Survey Soal
    public function deleteSurveySoal($no_urut)
    {
        $query = "DELETE FROM survey_soal WHERE no_urut =$no_urut";
        $result = $this->db->conn->query($query);
        return $result;
    }
}
